...
<div class="grid-cols-1 form">
  <div class="field">
    <x-ui.label for="name" value="Topic Name" />
    <x-ui.input id="name" name="name" type="text" value="{{ $topic->name ?? old('name') }}" required autofocus />
  ...
  <div class="field col-span-full">
    ...
    <x-ui.textarea id="description" name="description"
      rows="4">{{ $topic->description ?? old('description') }}</x-ui.textarea>
