...
<div class="grid grid-cols-1 gap-4 md:grid-cols-2 form">
  <div class="field">
    ...
    <x-ui.range id="teamwork" name="teamwork" type="range" value="{{ old('teamwork') ?? $feedback->teamwork }}"
      autofocus />
  ...
  <div class="field">
    ...
    <x-ui.range id="communication" name="communication" type="range"
      value="{{ old('communication') ?? $feedback->communication }}" />
    <x-ui.errors :messages="$errors->get('communication')" />
  </div>

  <div class="field">
    <x-ui.label for="initiative" value="Initiative" />
    <x-ui.range id="initiative" name="initiative" type="range"
  ...
  <div class="field">
    ...
    <x-ui.range id="problem_solving" name="problem_solving" type="range"
      value="{{ old('problem_solving') ?? $feedback->problem_solving }}" />
    <x-ui.errors :messages="$errors->get('problem_solving')" />
  </div>

  <div class="field">
    <x-ui.label for="adaptability" value="Adaptability" />
    <x-ui.range id="adaptability" name="adaptability" type="range"
      value="{{ old('adaptability') ?? $feedback->adaptability }}" />
    <x-ui.errors :messages="$errors->get('adaptability')" />
  </div>

  <div class="field">
    <x-ui.label for="leadership" value="Leadership" />
    <x-ui.range id="leadership" name="leadership" type="range"
