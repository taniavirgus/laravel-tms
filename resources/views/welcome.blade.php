    ...
    <style>
      ...
      @layer theme {
        ...
        :host {
          ...
          --inset-: inset 0 1px 1px #0000000d;
          --inset-: inset 0 2px 4px #0000000d;
          --drop-: 0 1px 1px #0000000d;
          --drop-: 0 1px 2px #00000026;
          --drop-: 0 3px 3px #0000001f;
          --drop-: 0 4px 4px #00000026;
          --drop-: 0 9px 7px #0000001a;
      ...
      @layer utilities {
        ...
        .0px_0px_1px_0px_rgba\(0\,0\,0\,0\.03\)\,0px_1px_2px_0px_rgba\(0\,0\,0\,0\.06\)\] {
          --tw-shadow: 0px 0px 1px 0px var(--tw-lor, #00000008), 0px 1px 2px 0px var(--tw-lor, #0000000f);
          box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow)
        }

        .inset_0px_0px_0px_1px_rgba\(26\,26\,0\,0\.16\)\] {
          --tw-shadow: inset 0px 0px 0px 1px var(--tw-lor, #1a1a0029);
          box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow)
        }
        ...
        @media (prefers-color-scheme:dark) {
          ...
          .dark\:inset_0px_0px_0px_1px_\#fffaed2d\] {
            --tw-shadow: inset 0px 0px 0px 1px var(--tw-lor, #fffaed2d);
            box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow)
          }
...
<body
  ...
  <div
    ...
    <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
      <div
        class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] nset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:nset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
      ...
      <div
        ...
        <div
          class="absolute inset-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg nset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:nset_0px_0px_0px_1px_#fffaed2d]">
        </div>
      </div>
    </main>
  </div>
