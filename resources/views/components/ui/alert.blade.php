...
@php
  $props = $attributes
      ->class([
          'border border-red-100 bg-red-50 text-red-800' => $variant === 'error',
          'border border-blue-100 bg-blue-50 text-blue-800' => $variant === 'info',
          'border border-green-100 bg-green-50 text-green-800' => $variant === 'success',
          'border border-yellow-100 bg-yellow-50 text-yellow-800' => $variant === 'warning',
      ])
      ->merge([
