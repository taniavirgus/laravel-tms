...
<div class="z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-base-100 rounded-xl"
  ...
  <div>
    <a href="#" class="flex px-4 py-3 border-b hover:bg-base-100">
      ...
      <div class="w-full pl-3">
        <div class="text-base-500 font-normal text-sm mb-1.5">
          New message from
          <span class="font-semibold text-base-900">Bonnie Green</span>: "Hey, what's up? All
    ...
    <a href="#" class="flex px-4 py-3 border-b hover:bg-base-100">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11"
          src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="Jese Leos avatar" />
        <div
          class="absolute flex items-center justify-center w-5 h-5 ml-6 -mt-5 border border-white rounded-full bg-base-900">
          <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <div class="w-full pl-3">
        <div class="text-base-500 font-normal text-sm mb-1.5">
          <span class="font-semibold text-base-900">Jese leos</span>
          and
          <span class="font-medium text-base-900">5 others</span>
    ...
    <a href="#" class="flex px-4 py-3 border-b hover:bg-base-100">
      ...
      <div class="w-full pl-3">
        <div class="text-base-500 font-normal text-sm mb-1.5">
          <span class="font-semibold text-base-900">Joseph Mcfall</span>
          and
          <span class="font-medium text-base-900">141 others</span>
    ...
    <a href="#" class="flex px-4 py-3 border-b hover:bg-base-100">
      ...
      <div class="w-full pl-3">
        <div class="text-base-500 font-normal text-sm mb-1.5">
          <span class="font-semibold text-base-900">Leslie Livingston</span>
    ...
    <a href="#" class="flex px-4 py-3 hover:bg-base-100">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11"
      ...
      <div class="w-full pl-3">
        <div class="text-base-500 font-normal text-sm mb-1.5">
          <span class="font-semibold text-base-900">Robert Brown</span>
  ...
  <a href="#" class="block py-2 font-medium text-center text-base-900 text-md bg-base-50 hover:bg-base-100">
    <div class="inline-flex items-center">
      <svg aria-hidden="true" class="w-4 h-4 mr-2 text-base-500 " fill="currentColor" viewBox="0 0 20 20"
        xmlns="http://www.w3.org/2000/svg">
